...
**Note:** JITProf has [a new version](https://github.com/Berkeley-Correctness-Group/jalangi2analyses). The new version greatly reduces the runtime overhead and supports checking JIT-unfriendly code on real-world websites. [Go and check out!](https://github.com/Berkeley-Correctness-Group/jalangi2analyses)
