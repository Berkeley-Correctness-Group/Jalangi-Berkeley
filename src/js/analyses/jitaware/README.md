...
**Note:** JITProf has [a new version](https://github.com/Berkeley-Correctness-Group/JITProf) which improves the runtime performance and supports checking JIT-unfriendly code on real-world websites. [Go and check out!](https://github.com/Berkeley-Correctness-Group/JITProf)
