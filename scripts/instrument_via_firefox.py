...
workingDir = os.path.dirname("/tmp/jalangiWorkingDir/")
...
for ex in excluded:
  if re.search(ex, realFileName):
    ...
    if libOption == "jalangiLibs":
      ...
      f.write(open(jalangiAnalysis).read())
      f.write("\n\n// END OF JALANGI LIBS\n\n")
...
if instrCodeOption == "instrumentCode":
  ...
  cmd = ["node", "/home/m/research/projects/jalangi/src/js/instrument/esnstrument.js", orig]
