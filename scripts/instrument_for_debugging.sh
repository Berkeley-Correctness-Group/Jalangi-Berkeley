...
node ../jalangi/src/js/commands/instrument.js --direct_in_output --copy_runtime --smemory --inbrowser --analysis src/js/analyses/CommonUtil.js --analysis src/js/analyses/inconsistentType/TypeUtil.js --analysis src/js/analyses/inconsistentType/CallGraph.js --analysis src/js/analyses/inconsistentType/FilterAndMerge.js --analysis src/js/analyses/inconsistentType/TypeAnalysis.js --analysis src/js/analyses/inconsistentType/InconsistentTypeEngine.js --outputDir instrumented/ instrument_for_debugging_tmp
