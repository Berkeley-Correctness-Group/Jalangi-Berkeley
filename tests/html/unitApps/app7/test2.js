    ...
    function readEscapedChar() {
        ...
        if (octal) {
            ...
            switch (ch) {
                ...
                case 85:
                    return String.fromCharCode(readHexChar(8)); // 'U'
                case 116:
                    return "\t"; // 't' -> '\t'
                case 98:
                    return "\b"; // 'b' -> '\b'
...
(function(sandbox) {
    ...
    function storeInitialIID(outputDir) {
        ...
        var line;
        var iidf = path.join(outputDir ? outputDir : process.cwd(), INITIAL_IID_FILE_NAME);
        fs.writeFileSync(iidf, line = JSON.stringify({
            condCount: condCount,
            iid: iid,
            opIid: opIid
        }));
    ...
    function writeIIDMapFile(outputDir, initIIDs, isAppend) {
        ...
        fs.writeFileSync(path.join(outputDir, COVERAGE_FILE_NAME), JSON.stringify({
            "covered": 0,
            "branches": condCount / IID_INC_STEP * 2,
            "coverage": []
        }), "utf8");
    }
                ...
                if (ast.body[0].type === 'ExpressionStatement') {
                    if (ast.body[0].expression.type === 'CallExpression') {
                        if (ast.body[0].expression.callee.object &&
                            ast.body[0].expression.callee.object.name === 'J$' && ast.body[0].expression.callee.property &&
    ...
    function instrumentAux(code, args) {
        ...
        var codeAndMData = instrumentCode(code, {
    ...
    function instrumentFile() {
        ...
        parser.addArgument(['--initIID'], {
            help: "Initialize IIDs to 0",
            action: 'storeTrue'
        });
        parser.addArgument(['--noInstrEval'], {
...
(function(sandbox) {
    ...
    var orig2Inst = sandbox.orig2Inst;
    var fn = "/home/m/research/projects/Jalangi-Berkeley/instrumentFF_tmp/http127.0.0.18000testshtmlunitAppsapp6test.js";
    iids[9] = [fn, 4, 13, 4, 17];
    iids[10] = [fn, 4, 12, 4, 17];
    iids[17] = [fn, 4, 12, 4, 17];
    iids[18] = [fn, 7, 13, 7, 37];
    iids[25] = [fn, 3, 1, 5, 2];
    iids[33] = [fn, 3, 1, 5, 2];
    iids[41] = [fn, 7, 1, 7, 8];
    iids[49] = [fn, 7, 13, 7, 24];
    iids[57] = [fn, 7, 27, 7, 35];
    iids[65] = [fn, 7, 27, 7, 37];
    iids[73] = [fn, 7, 1, 7, 38];
    iids[75] = [fn, 7, 1, 7, 12];
    iids[81] = [fn, 3, 1, 7, 39];
    iids[89] = [fn, 3, 1, 5, 2];
    ...
    iids[105] = [fn, 3, 1, 5, 2];
    iids[113] = [fn, 3, 1, 5, 2];
    iids[121] = [fn, 3, 1, 7, 39];
    iids[129] = [fn, 3, 1, 7, 39];
    orig2Inst["/home/m/research/projects/Jalangi-Berkeley/instrumentFF_tmp/http127.0.0.18000testshtmlunitAppsapp6test.js"] = "/home/m/research/projects/Jalangi-Berkeley/instrumentFF_tmp/http127.0.0.18000testshtmlunitAppsapp6test_jalangi_.js";
}(typeof J$ === 'undefined' ? J$ = {} : J$));
J$.noInstrEval = true;
jalangiLabel1: while (true) {
    try {
        J$.Se(81, '/home/m/research/projects/Jalangi-Berkeley/instrumentFF_tmp/http127.0.0.18000testshtmlunitAppsapp6test_jalangi_.js');

        function isStrict() {
            jalangiLabel0: while (true) {
                try {
                    J$.Fe(25, arguments.callee, this, arguments);
                    arguments = J$.N(33, 'arguments', arguments, true, false, false);
                    return J$.Rt(17, J$.U(10, '!', J$.R(9, 'this', this, false, false)));
                } catch (J$e) {
                    J$.Ex(105, J$e);
                } finally {
                    if (J$.Fr(113))
        ...
        isStrict = J$.N(97, 'isStrict', J$.T(89, isStrict, 12, false), true, false, false);
        J$.M(73, J$.I(typeof console === 'undefined' ? console = J$.R(41, 'console', undefined, true, true) : console = J$.R(41, 'console', console, true, true)), 'log', false)(J$.B(18, '+', J$.T(49, 'Strict?? ', 21, false), J$.F(65, J$.R(57, 'isStrict', isStrict, false, true), false)()));
    } catch (J$e) {
        J$.Ex(121, J$e);
    } finally {
        if (J$.Sr(129))
